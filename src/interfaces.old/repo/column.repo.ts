import { COLUMNS_PER_PAGE } from "../../config.old/constants/pagination";
import db from "../../config.old/db";
import { PostgresDatabaseConn } from "../../pg/postgresdb.service";
import { getOffset } from "../../shared.old/utils/get-offset";
import { snakeToCamel } from "../../shared.old/utils/snake-to-camel";
